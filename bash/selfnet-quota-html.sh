...
curl --silent http://www.selfnet.de/quota/ | grep '<div style="position:relative; z-index:1; font-size:14pt; margin:3px">' | cut -b 72- | sed -e 's/&nbsp;/ /g' | rev | cut -b 7- | rev | sed -e 's/GB/GiB /g'
